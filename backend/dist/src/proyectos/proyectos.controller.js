...
const crear_proyecto_dto_1 = require("./dto/crear-proyecto.dto");
...
let ProyectosController = class ProyectosController {
    ...
    async crearProyecto(req, dto) {
        const usuarioId = req.user.userId;
        return this.proyectosService.crearProyecto(usuarioId, dto);
    }
    async listarProyectos(req) {
        const usuarioId = req.user.userId;
        return this.proyectosService.listarProyectos(usuarioId);
    }
    async obtenerProcesos(req, id) {
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('ADMIN', 'PMO', 'DIRECTOR_PMO', 'PM'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, crear_proyecto_dto_1.CrearProyectoDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProyectosController.prototype, "listarProyectos", null);
__decorate([
    (0, common_1.Get)(':id/procesos'),
    (0, roles_decorator_1.Roles)('ADMIN', 'PMO', 'DIRECTOR_PMO', 'PM', 'PARTE_INTERESADA', 'GERENCIA', 'PRESIDENCIA'),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", Promise)
], ProyectosController.prototype, "obtenerProcesos", null);
